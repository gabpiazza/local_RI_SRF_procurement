...
saveRDS(twfe_manufacturing_2012,file = here("results","output", "twfe_manufacturing_2012.rds"))
saveRDS(twfe_manufacturing_dynamic,file = here("results","output", "twfe_manufacturing_dynamic.rds"))

output_twfe_2012 <- capture.output(summary(twfe_manufacturing_2012))
writeLines(output_twfe_2012, here("results","tables","twfe_manufacturing_2012_output.txt"))

output_twfe_dynamic <- capture.output(summary(twfe_manufacturing_dynamic))
writeLines(output_twfe_dynamic, here("results","tables","twfe_manufacturing_dynamic_output.txt"))


### Trajectory Balancing Results --------------------------------------------
...
saveRDS(out_manufacturing_shift_2012_covariates.kbal,file = here("results","output", "out_manufacturing_2012_mun.rds"))# 
...
# estimate for all the other units in the donor pool 
...
write.csv(check_2012_covariates_manufacturing,file = here("results","output","out_placebo_manufact.csv"))
...
##### Trajectory balancing method for LMA --------------------------------
...
write.csv(check_2012_covariates_lma_manufacturing,file = here("results","output","out_placebo_lma_manufact.csv"))
